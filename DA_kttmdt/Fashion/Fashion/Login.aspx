<%@ Page Language="C#" MasterPageFile="~/Master/Menu.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Fashion.Login" %>
    ...
    <div class="container">
        <div class="row">
            <div class="page-login pagecustome clearfix">
                <div class="wpx">
                    <h1 class="title_heads a-center">Đăng nhập</h1>
                    <div class="register-link-1  margin-top-10">
                        Nếu bạn chưa có tài khoản,
                        <a href="../Register.aspx" class="register-link-2">đăng ký tại đây</a>

                    </div>
                    <div class="section">
                        <div class="form-signup">
                            <div class="input-textbox">
                                <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control-lg" placeholder="Tên đăng nhập" Required="true"></asp:TextBox>
                                <br />
                                <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" CssClass="form-control-lg" placeholder="Mật khẩu" Required="true"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    ...
                    <%--<span class="block quenmk"><a href="javascript:void(0)">Quên mật khẩu</a></span>--%>
                </div>
                </div>
            </div>
        </div>
